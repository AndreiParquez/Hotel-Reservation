...
<body>
       ...
       <header class="header">
        ...
        <ul>
            ...
            <li><a href="#main">Reservation</a></li>
    ...
    <div class="sec" id="sec">
      ...
      <p>Welcome to Hotel Transylvania, our primary goal is to revolutionize hotel reservation management.<br> <br>We are driven by a mission to simplify and enhance the hotel booking experience for both guests and hoteliers.<br>Our cutting-edge reservation management system offers a seamless, user-friendly platform that streamlines the booking process, improves occupancy rates, and boosts revenue for hotels. 
 <br>We understand the unique needs of the hospitality industry, and our system is designed to provide real-time availability, secure transactions, and comprehensive booking analytics. <br /> As your trusted partner in hotel reservation management, we are committed to helping you maximize your bookings, improve guest satisfaction, and ultimately, achieve excellence in the competitive world of hotel management.<br /> </p>
      <div class="main" id="main"><br /><br /><br />
        <h2>Rooms Rate</h2>
        <ul class="cards">
          <li class="cards_item">
            <div class="card">
